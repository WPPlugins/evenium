...
class Evenium_Quicktags
{
	...
	public function evenium_list_events($atts, $content)
	{
        ...
        $html = '<script type="text/javascript" src="https://evenium.net/ng/js/widgets/web-widget.js?from=wp&name=events&memberId=' . $a['id'];
	...
	public function evenium_single_event($atts, $content)
	{
        ...
        $html = '<script type="text/javascript" src="https://evenium.net/ng/js/widgets/web-widget.js?from=wp&name=ticketing&eventId=' . $a['id'];
        $html = evenium_add_params_widget_url($html);
        $html .= '"></script>';
		return $html;
	}
	...
	public function evenium_event_agenda($atts, $content)
	{
        ...
        $html = '<script src="https://evenium.net/ng/js/widgets/web-widget.js?from=wp&name=program&eventId=' . $a['id'];
        $html = evenium_add_params_widget_url($html);
        $html .= '"></script>';
		return $html;
	}
